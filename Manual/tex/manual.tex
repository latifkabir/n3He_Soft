...
\newpage
\section{ADC to Volt conversion}
...
We have a 24 bit ADC with +10 V to -10 V range.
$$Precision =\frac{20 Volt}{2^{24}}$$
Thus $1.192092896\times10^{-6}$ will be the conversion factor from ADC value to volt. Also to throw away the least significant 8 bit out of 32 bit, you can do $ADC Count>>8$ in your analysis code. 
